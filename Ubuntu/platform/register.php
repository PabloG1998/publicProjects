          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="phone" id="phoneNumber" class="form-control form-control-lg" />
                  <label class="form-label" for="phoneNumber">Teléfono</label>
                </div>

                <div class="d-flex justify-content-center">
                  <button  type="button" data-mdb-button-init
                    data-mdb-ripple-init class="btn btn-success">Registrarse</button>
                </div>

                <p class="text-center text-muted mt-5 mb-0">Ya tiene una cuenta? <a href="#!"
